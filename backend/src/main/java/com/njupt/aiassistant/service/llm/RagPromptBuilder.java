...
public class RagPromptBuilder {
    ...
    private static final String LIMITED_CONTEXT_RULE =
            "\n8. 检索到的片段只是知识库的有限上下文，不得据此推断整个知识库"
                    ...
                    + "9. 回答“甲专业转乙专业”时，以乙专业或乙学院的接收细则为准，"
                    + "再补充学校统一规则；甲专业细则只有明确写出转出限制时才可作为限制依据。\n"
                    + "10. 若目标细则写明“不限专业”，应直接说明来源专业不构成额外限制；"
                    + "若只有学校统一规则而没有目标细则，应表述为“当前片段未包含目标专业"
                    + "的具体接收条件”，不得声称知识库没有该专业资料。\n";
